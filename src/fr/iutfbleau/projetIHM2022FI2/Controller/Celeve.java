...
public class Celeve {
    ...
    public void chGroup(Groupe grp){
        changementFactory.createChangement(groupeFactory.getGroupesOfEtudiant(himself).iterator().next(), himself, grp);
    }
